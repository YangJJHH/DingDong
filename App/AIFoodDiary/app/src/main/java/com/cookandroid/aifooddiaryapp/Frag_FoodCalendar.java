...
public class Frag_FoodCalendar extends Fragment {
    ...
    // 위젯 변수 생성
    TextView tv_date;
    CardView cv_morning, cv_after, cv_dinner, cv_snack;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        cv_after = (CardView) view.findViewById(R.id.cv_after);
        ...
        img_after = (ImageView) view.findViewById(R.id.img_after);
        ...
        // cv_after 클릭 했을 때의 이벤트 처리
        cv_after.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                Frag_Camera frag_camera = new Frag_Camera();
